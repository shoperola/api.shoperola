...
import {verify_email, send_email,list_verified_emails,view_email_template,view_email_template_byid,create_email_template,update_email_template,delete_email_template} from "./AWS-SES";
const router = Router();

router.post('/send/:id',send_email);
